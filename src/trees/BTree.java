 ...
 * @author Dravit Gupta
 * <pre>
 * Binary Tree : Tree where each node has up to two leaves, it does not garaunteed that all the left nodes are lessa and right nodes are greater.
 * BTree(Binary Search Tree) is a self balancing tree data structure that keeps data sorted and allows searches, sequential access, insertion and deletion in lograthmic time.
 * This is a specialized form of Binary tree and it is used for searching.
...
public class BTree {
    ...
    private static final class BNode {
        ...
        /**
         * In order Traversal means traversal of all values in ascending order.
         */
        ...
        /**
         * Pre order traversal means traversal prints first the root node than the left child and than the right child of that tree.
         */
        ...
        /**
         * Post order traversal means first visit all children nodes first(and their subtrees) and than visit the root node.
         */
        ...
        /**
         * Reverser level order traversal prints all the nodes of one level and than move to the level above it.
         * This is done by using a stack, in which first push the node from which traversal has to be done
         * Than push the right and than left child of that node to stack
         * Than go to right child of that node and than go to left child of that node and repeat above last step.
         */
